...
namespace Microsoft.VisualStudio.Project
{
	...
	public class SingleFileGeneratorFactory : IVsSingleFileGeneratorFactory
	{
		...
		private class GeneratorMetaData
		{
			...
			/// <summary>
			/// GeneratesDesignTimeSource _Reg value name under HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\VisualStudio\[VsVer]\Generators\[ProjFacGuid]\[GeneratorProgId]
			/// </summary>
			...
			/// <summary>
			/// GeneratesSharedDesignTimeSource _Reg value name under HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\VisualStudio\[VsVer]\Generators\[ProjFacGuid]\[GeneratorProgId]
			/// </summary>
			...
			/// <summary>
			/// UseDesignTimeCompilationFlag _Reg value name under HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\VisualStudio\[VsVer]\Generators\[ProjFacGuid]\[GeneratorProgId]
			/// </summary>
		...
		/// <summary>
		/// CLSID _Reg value name under HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\VisualStudio\[VsVer]\Generators\[ProjFacGuid]\[GeneratorProgId]
		/// </summary>
