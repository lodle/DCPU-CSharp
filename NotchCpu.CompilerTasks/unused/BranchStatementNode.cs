...
namespace DCPUC
{
    public class BranchStatementNode : CompilableNode
    {
        ...
        public static ClauseOrder CompileConditional(Assembly assembly, Scope scope, CompilableNode conditionNode)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    (conditionNode.ChildNodes[1] as CompilableNode).DoCompile(assembly, scope, (Register)secondRegister);
                }
                ...
                else
                {
                    ...
                    (conditionNode.ChildNodes[0] as CompilableNode).DoCompile(assembly, scope, (Register)firstRegister);
                }
        ...
        public static void CompileBlock(Assembly assembly, Scope scope, CompilableNode block, String file, SourceSpan span)
        {
            var blockScope = BeginBlock(assembly, scope, file, span);
            assembly.Barrier();
            block.Compile(assembly, blockScope, Register.DISCARD);
            assembly.Barrier();
            EndBlock(assembly, blockScope, file, span);
        }
